...
<div>
    <main-menu>
        <div class="bg-black">
            <div class="row background-main-img items-center justify-center" v-bind:style="{
            backgroundImage:
              ...
              ')',
                ...
                <div class="col-12 col-md-8 text-center text-white q-pa-md">
                    ...
                    <q-form ref="formBuscarLojas" class="q-gutter-md">
                        <q-input rounded outlined dark v-model="buscaCep.cep" mask="#####-###" unmasked-value color="orange" bg-color="dark" style="opacity: 0.9" lazy-rules :rules="[ val => val !== null && val.length == 8 || 'Informe um CEP válido!']" v-on:keydown.enter.prevent='buscarLojas'>
        ...
        <div class="row q-pa-md q-col-gutter-md q-my-lg">
            <div class="col-12 col-md-4">
                <q-card class="my-card shadow-5">
                    <div class="zoom-effect-container">
                        <q-img class="image-card" :src="card1" transition="jump-up" spinner-color="orange">
                            <div class="absolute-bottom text-center bg-card-title">
                                <span class="text-h5 q-py-none text-card">Veja qual supermercado está mais próximo de você!</span>
                            </div>
                        </q-img>
                    </div>
                </q-card>
            ...
            <div class="col-12 col-md-4">
                <q-card class="my-card shadow-5">
                    <div class="zoom-effect-container">
                        <q-img class="image-card" :src="card2" transition="jump-up" spinner-color="orange">
                            <div class="absolute-bottom text-center bg-card-title">
                                <span class="text-h5 q-py-none text-card">Faça sua compra em apenas alguns cliques!</span>
                            </div>
                        </q-img>
                    </div>
                </q-card>
            ...
            <div class="col-12 col-md-4">
                <q-card class="my-card shadow-5">
                    <div class="zoom-effect-container">
                        <q-img class="image-card" :src="card3" transition="jump-up" spinner-color="orange">
                            <div class="absolute-bottom text-center bg-card-title">
                                <span class="text-h5 q-py-none text-card">Veja qual supermercado está mais próximo de você!</span>
                            </div>
                        </q-img>
        ...
        <div class="row bg-login-empresa q-py-xl q-mb-none justify-center">
            <div class="col-12 text-white text-center">
                ...
                <q-btn push rounded class="bg-btn-empresa" icon="fas fa-briefcase" label="Entrar ou Cadastrar" @click="abrirModalLoginEmpresa" />
            </div>
        </div>
        <br /><br />

        <modal-login-empresa :mostraModal="modal.login" @fecharModal="fecharModalLoginEmpresa"></modal-login-empresa>
    </main-menu>
</div>
</template>
