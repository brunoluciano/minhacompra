...
<div class="bg-custom q-py-md">
    <main-menu>
        <div class="row q-mx-lg q-mb-none text-white items-end justify-between">
                    ...
                    <q-item-section class="text-shadow">
                        ...
                        <q-item-label caption class="q-ma-none q-pa-none">
                            <div class="text-p text-white">
                                ...
                                {{ loja.estado.descricao }} - {{ loja.estado.sigla }}
                            </div>
                        </q-item-label>
                    </q-item-section>
                </q-item>
            ...
            <q-item>
                <q-item-section>
                    <router-link :to="{ name: 'buscarlojas' }" class="remove-link-style">
                        <q-btn outline rounded color="white" icon="logout" label="Voltar para Supermercados" no-caps />
                    </router-link>
                </q-item-section>
            </q-item>
            <!-- </div> -->
